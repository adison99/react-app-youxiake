...
export const MIndexLocal=styled.div`
    .mIndexLocal {
        position: relative;
        display: -webkit-box;
        display: -ms-flexbox;
    ...
    .mIndexLocal .mIndexLocal__top .top__left div {
        ...
        font-size: .28rem;
        color: #fff;
        background: url(https://m.youxiake.com/static/img/img26.404d96e.png) 50% no-repeat;
        background-size: 4.55rem .98rem;
    }
